...
@section('content')
<section class="hero-area" style="background-image: url({{ asset('theme/images/home/bg-airport.jpg') }})">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="hero-area-slider owl-carousel">
                    <div class="single-slider-item">
                        <div class="text-center">
                            <h1>Airport Tarnsfer Service</h1>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section-padding our-service-section">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="section-title">Airport Transport Service</h2>
                <div class="about-us-text">
                    {!! setting('airport_transport') !!}
                </div>
            </div>
        </div>
    </div>
